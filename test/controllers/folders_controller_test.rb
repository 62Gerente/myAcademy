...
class FoldersControllerTest < ActionController::TestCase
  ...
  test "should create folder" do
    assert_difference('Folder.count') do
      post :create, folder: { folder_id: @folder.folder_id, name: @folder.name, subject_id: @folder.subject_id }
    end
  ...
  test "should update folder" do
    patch :update, id: @folder, folder: { folder_id: @folder.folder_id, name: @folder.name, subject_id: @folder.subject_id }
    assert_redirected_to folder_path(assigns(:folder))
  end
