...
class FilesControllerTest < ActionController::TestCase
  ...
  test "should create file" do
    assert_difference('File.count') do
      post :create, file: { folder_id: @file.folder_id, name: @file.name, subject_id: @file.subject_id }
    end
  ...
  test "should update file" do
    patch :update, id: @file, file: { folder_id: @file.folder_id, name: @file.name, subject_id: @file.subject_id }
    assert_redirected_to file_path(assigns(:file))
  end
